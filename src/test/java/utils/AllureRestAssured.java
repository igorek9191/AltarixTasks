...
public class AllureRestAssured implements OrderedFilter {
    ...
    public Response filter(final FilterableRequestSpecification requestSpec,
        ...
        String httpRequest = "\nREQUEST "+ requestAttachment.getMethod() +"\n"+ requestAttachment.getUrl() +"\n"+
                requestAttachment.getHeaders() +"\n"+ (requestAttachment.getBody()==null ? "No body" : requestAttachment.getBody()) ;
        LOG.info(httpRequest);

        String httpResponse = "\nRESPONSE " + responseAttachment.getName() +"\n"+ responseAttachment.getHeaders() +"\n"+
                ((responseAttachment.getBody() == null) || (responseAttachment.getBody().isEmpty()) ? "No body" : responseAttachment.getBody()) ;
